...
{% figures id="work-cycle" caption="工作项目的交付与反馈循环" %}
...
{% figures id="shared-cycle" caption="科研与工作共享的问题求解循环" %}
...
{% table id="research-work-cycle" caption="科学研究与工作项目的问题求解对照" %}
...
{% table id="paradigm-bottlenecks" caption="五种范式的能力叠加与瓶颈转移" %}
...
{% table id="candidate-states" caption="候选流的状态与处理" %}
